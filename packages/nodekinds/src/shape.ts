...
export const shapeKind: NodeKind = {
  ...
  schema: {
    ...
    inspector: [
      ...
      { path: "props.width",       label: "Width",        control: "number", min: 1,   max: 4000, step: 1,    unit: "px" },
      { path: "props.height",      label: "Height",       control: "number", min: 1,   max: 4000, step: 1,    unit: "px" },
      { path: "props.radius",      label: "Corner radius",control: "number", min: 0,   max: 500,  step: 1,    unit: "px" },
      { path: "props.sides",       label: "Sides",        control: "number", min: 3,   max: 20,   step: 1    },
      { path: "props.points",      label: "Points",       control: "number", min: 3,   max: 20,   step: 1    },
      { path: "props.innerRatio",  label: "Inner ratio",  control: "number", min: 0.1, max: 0.9,  step: 0.05 },
      { path: "props.headRatio",   label: "Head ratio",   control: "number", min: 0.1, max: 0.9,  step: 0.05 },
      { path: "props.shaftRatio",  label: "Shaft ratio",  control: "number", min: 0.1, max: 0.9,  step: 0.05 },
      { path: "props.fill",        label: "Fill",         control: "color" },
      { path: "props.strokeColor", label: "Stroke color", control: "color" },
      { path: "props.strokeWidth", label: "Stroke width", control: "number", min: 0, max: 40, step: 0.5, unit: "px" },
    ],
  },
  defaults: () => ({
    name: "Shape",
